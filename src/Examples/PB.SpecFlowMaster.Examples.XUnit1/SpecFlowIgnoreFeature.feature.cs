...
namespace PB.SpecFlowMaster.Examples.XUnit1
{
    ...
    public partial class SpecFlowIgnoreFeatureFeature : Xunit.IUseFixture<SpecFlowIgnoreFeatureFeature.FixtureData>, System.IDisposable
    {
...
#line hidden
        ...
        public SpecFlowIgnoreFeatureFeature()
        {
            this.TestInitialize();
        }
...
#line hidden
        ...
        public virtual void SetFixture(SpecFlowIgnoreFeatureFeature.FixtureData fixtureData)
        {
        }
